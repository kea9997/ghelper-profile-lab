...
(() => {
  ...
  async function load(reset) {
    ...
    try {
      ...
      if (!count) empty(query ? '검색 결과가 없습니다.' : '아직 공유된 설정이 없습니다.', query ? '다른 모델명이나 사양으로 검색해 보세요.' : 'Windows 앱에서 첫 설정을 공유하면 이곳에 표시됩니다.');
