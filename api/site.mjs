...
<body>
  <header class="topbar wrap">
    ...
    <nav aria-label="바로가기"><a href="#library">공유 설정</a><a href="#how-it-works">사용 방법</a><a href="#support">개발 후원</a></nav>
  ...
  <main>
    <section class="hero wrap" aria-labelledby="hero-title">
      <div class="hero-copy">
        ...
        <p class="hero-lead">G-Helper 설정을 백업하고, 조용·균형·터보 모드의 Time Spy 점수와 소음 기록을 함께 남기는 Windows 앱입니다. 내 점수를 PNG 카드로 저장해 공유하고, 다른 사용자가 공개한 설정도 살펴볼 수 있습니다.</p>
    ...
    <section id="how-it-works" class="how-section wrap"><div class="section-heading"><div><span class="section-kicker">HOW IT WORKS</span><h2>처음이라도 간단하게</h2></div></div><div class="steps"><article><span>01</span><h3>현재 설정 저장</h3><p>Windows 앱에서 G-Helper 설정과 노트북 사양을 읽어 내 프로필로 저장합니다.</p></article><article><span>02</span><h3>결과 기록과 이미지 저장</h3><p>Time Spy 점수에 팬 RPM과 소음 기록을 남기고, 비교 이미지를 PNG로 저장합니다.</p></article><article><span>03</span><h3>공유하고 살펴보기</h3><p>공개한 설정은 이 자료실에 표시됩니다. 적용 전에는 앱에서 설정 내용을 확인할 수 있습니다.</p></article></div></section>
    <section id="support" class="support-section wrap"><div><span class="section-kicker">SUPPORT THE PROJECT</span><h2>개발을 응원해 주세요</h2><p>앱은 무료로 사용할 수 있습니다. 도움이 되었다면 GitHub Sponsors에서 선택적으로 후원해 주세요. 후원 프로필이 공개된 뒤 결제할 수 있습니다.</p></div><a class="button button-secondary" href="https://github.com/sponsors/kea9997" target="_blank" rel="noopener noreferrer">GitHub Sponsors 열기 ↗</a></section>
  </main>
